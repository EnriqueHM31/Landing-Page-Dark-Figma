...
export default function CardQuestions({ question, answer, link }: CardPropertiesProps) {
	return (
		<div className="xl:flex-1 flex flex-col gap-4 bg-black p-8 my-7 rounded-2xl border border-white/15 hover:border-white transition-colors justify-between min-h-[300px] xl:min-h-[500px] items-stretch">
